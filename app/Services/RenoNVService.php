...
class RenoNVService implements LocationServiceInterface {
    ...
    public function getTechnology() {
        ...
        $tech1->text1 = "You may have noticed how hard it is to find software engineers that are actually located in the Reno area.";
        $tech1->text2 = "Zenivora is a local business here in Reno, NV!";
        ...
        $tech2->img = "seo.svg";
        $tech2->text1 = "Web agencies love to promise the world. Look at how many low-quality, low-performing sites there are in Reno, NV.";
