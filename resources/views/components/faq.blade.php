<section class="w-full min-h-screen flex flex-col justify-center items-center text-white my-36" id="faq">
    <h2 class="text-white text-3xl font-mont font-extrabold text-center">{!! $information->title !!}</h2>
    <div class="flex flex-col md:w-3/4 font-mont mt-10 px-6 md:px-0">
