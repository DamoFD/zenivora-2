<section class="w-full min-h-screen flex justify-center items-center flex-col mt-56 lg:mt-0" id="technology">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 w-11/12 lg:w-3/4 mt-10">
            <div>
                ...
                <p class="text-white text-lg lg:text-xl font-mont font-extrabold mt-10">Here is our benchmark for the <a class="text-brand-primary underline" href="https://discordbrowser.com">DiscordBrowser.</a></p>
                <p class="text-white text-lg lg:text-xl font-mont font-extrabold mt-2 mb-5">Check the benchmark for your site at <a class="text-brand-primary underline" href="https://pagespeed.web.dev/">Google's Pagespeed Insights.</a></p>
